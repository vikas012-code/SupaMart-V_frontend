function AdminOrder({props}) {
    ...
    return (
        <div className="pb-10 mt-10 flex flex-col items-center">
            <h3 className=" self-start p-5 -mt-7 font-bold  text-3xl max-md:text-lg">
                Total Orders List
            </h3>
                    <div className="bg-white w-[93%] pb-6 rounded-2xl flex flex-col items-center">
                        <div className=" border-b-2 border-gray-300 w-[90%] py-4">
                            <h3 className="text-2xl font-bold max-md:text-lg">All Recent Purchases</h3>
                        </div>
                        <table className="w-[90%] text-center">
                            <thead className="border-b-2 border-gray-300 text-xl opacity-40 max-md:text-sm max-sm:text-[0.5rem]">
