...
function CheckOutProgress(){
    ...
    return <>
        <div className="flex justify-center items-center pt-5 duration-300">
            ...
            <p className=" max-sm:text-xs"> Shipping Details</p>
            </span>

            <span className={`${ProgressBar>1?"bg-blue-600":"bg-gray-300 "} w-30 h-2 relative bottom-3 -mx-8 max-sm:bottom-2`}>
            ...
            <p className="max-sm:text-xs"> Payment details</p>
            </span>

            <span className={`${ProgressBar>2?"bg-blue-600":"bg-gray-300"} w-30 h-2 relative bottom-3 -mx-8 max-sm:bottom-2`}>
            ...
            <p className="max-sm:text-xs">Ordered Placed </p>
            </span>
        </div>
    </>
}
